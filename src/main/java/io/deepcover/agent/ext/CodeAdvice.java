 ...
 */
public class CodeAdvice implements Attachment {
    ...
    private CodeAdvice top = this;
    private CodeAdvice parent = this;
     ...
     */
    CodeAdvice(final int processId,
           final int invokeId,
    ...
    CodeAdvice applyBefore(final CodeAdvice top,final CodeAdvice parent) {
        this.top = top;
        this.parent = parent;
        return this;
    }
     ...
     * @return this
     */
    CodeAdvice applyReturn(final Object returnObj) {
     ...
     * @return this
     */
    CodeAdvice applyThrows(final Throwable throwable) {
     ...
     * @return this
     */
    public CodeAdvice changeParameter(final int index,
    ...
    public boolean equals(Object obj) {
        if (obj instanceof com.alibaba.jvm.sandbox.api.listener.ext.Advice) {
            final CodeAdvice advice = (CodeAdvice) obj;
     ...
     * @return 调用顶层通知
     */
    public CodeAdvice getProcessTop() {
        return top;
    }
     ...
     */
    public List<CodeAdvice> listHasMarkOnChain(final String exceptMark) {
        final List<CodeAdvice> advices = new ArrayList<>();
