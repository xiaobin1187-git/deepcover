...
import java.util.*;
//
//public class CodeInfoReflectionUtils extends ReflectionUtils {
//
//}
...
public class CodeInfoReflectionUtils {
    ...
    private static final Map<Class<?>, Annotation[]> declaredAnnotationsCache = new ConcurrentReferenceHashMap(256);
    ...
    public CodeInfoReflectionUtils() {
    }
    ...
    public static void doWithMethods(Class<?> clazz, org.springframework.util.ReflectionUtils.MethodCallback mc) {
        doWithMethods(clazz, mc, (org.springframework.util.ReflectionUtils.MethodFilter)null);
    }
    ...
    public static Method[] getUniqueDeclaredMethods(Class<?> leafClass) {
        ...
        doWithMethods(leafClass, new org.springframework.util.ReflectionUtils.MethodCallback() {
            public void doWith(Method method) {
                ...
                if (!knownSignature && !org.springframework.util.ReflectionUtils.isCglibRenamedMethod(method)) {
                    methods.add(method);
                }
    ...
    public static Annotation[] getDeclaredAnnotations(Class<?> clazz) {
        Assert.notNull(clazz, "Class must not be null");
        Annotation[] result = (Annotation[])declaredAnnotationsCache.get(clazz);
        if (result == null) {
            Annotation[] annotations = clazz.getAnnotations();
            result = annotations;
            declaredAnnotationsCache.put(clazz, result.length == 0 ? NO_ANNOTATIONs : result);
        }
    ...
    public static void doWithFields(Class<?> clazz, org.springframework.util.ReflectionUtils.FieldCallback fc) {
        doWithFields(clazz, fc, (org.springframework.util.ReflectionUtils.FieldFilter)null);
    }
